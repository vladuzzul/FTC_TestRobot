...
public class MainAutoOp extends BaseAuto {
    ...
    private PathChain goToIntake1, goIntake1, goToLaunch1, goToIntake2, goIntake2, goToLaunch2, goToIntake3, goIntake3, goToLaunch3, gotToStart;
//    private PathChain goFront, goBack;
    ...
    public void onAutoInit() {
        ...
        goToLaunch1 = robot.follower.pathBuilder()
                .addPath(new BezierLine(intake11, launchZone))
                .setLinearHeadingInterpolation(intake11.getHeading(), launchZone.getHeading())
                .build();
        ...
        goToLaunch2 = robot.follower.pathBuilder()
                .addPath(new BezierLine(intake21, launchZone))
                .setLinearHeadingInterpolation(intake21.getHeading(), launchZone.getHeading())
                .build();
        ...
        goToLaunch3 = robot.follower.pathBuilder()
                .addPath(new BezierLine(intake31, launchZone))
                .setLinearHeadingInterpolation(intake31.getHeading(), launchZone.getHeading())
                .build();
